...
<center><h1>Your account has been created!enjoy your discussion</h1></center>
...
<textarea id="countMe" cols="70" rows="2" name="tarea" style="font-size:18px;resize:none;wrap:hard;border-radius:5px;border:solid #333366;" placeholder="JOIN US FOR DISCUSSION"></textarea>
				...
				<tr>
					...
					<td><input type="submit" value=<%=pdf%> name="tarea" readonly="readonly" style="background:-webkit-linear-gradient(top,  #2c354e 0%,#576a97 100%);color:#FFFFFF;width:100%;">
					</td>
					</tr>
