...
<frameset rows="23%,*" frameborder="no" >
	<frame src="afterlogin1.jsp" id="ch1" scrolling="no">
		<frameset cols="50%,*">
			<frame name="frame1" id="frm1" src ="java1.html"style="background:-webkit-linear-gradient(top,  #2c354e 0%,#576a97 100%);color:#FFFFFF;">
			<frame name="frame2" src="whatisjava.html">
		</frameset>
